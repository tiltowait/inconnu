...
def test_name_normalized_whitespace():
...
def test_blood_potency_vampire_range():
...
# Blood potency splat validation tests


def test_mortal_requires_zero_potency():
...
def test_ghoul_requires_zero_potency():
...
def test_thin_blood_potency_range():
...
# Convictions validation tests


def test_valid_convictions():
...
def test_conviction_max_length():
...
def test_description_max_length():
    """Description at 1024 characters passes."""
...
def test_description_too_long():
    """Description longer than 1024 characters rejected."""
...
# Trait name validation tests


def test_valid_trait_name():
...
def test_trait_name_with_underscore():
...
def test_trait_name_invalid_characters():
...
def test_trait_name_with_apostrophe_rejected():
...
def test_reserved_trait_rejected():
...
def test_duplicate_trait_names_rejected():
...
def test_duplicate_trait_names_case_insensitive():
...
# Specialty (subtrait) validation tests


def test_valid_specialty_on_skill():
...
def test_valid_specialty_on_custom_trait():
...
def test_specialty_on_attribute_rejected():
...
def test_powers_on_discipline_allowed():
...
def test_specialty_name_too_long():
...
def test_specialty_name_invalid_characters():
...
def test_duplicate_specialty_names_rejected():
...
def test_duplicate_specialty_names_case_insensitive():
...
def test_minimal_valid_character():
...
def test_complete_valid_vampire():
